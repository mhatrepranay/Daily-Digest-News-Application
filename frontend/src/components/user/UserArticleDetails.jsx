                        ...
                        <div className="hide1 flex-1 pl-3 overflow-auto h-screen">
                            <div className="sticky top-0 z-10 rounded-lg bg-white shadow-md pl-[20vh] pt-2">
                                <div className="flex items-center justify-between mb-4 overflow-x-auto">
                                    ...
                                    <div className="flex mb-1">
                                        <Link to={"/dashbord-user"} className='flex items-center mr-5'>
                            ...
                            </div>
                            {
                                showAllArticles ? (
                                                ...
                                                <div key={article._id} className={`bg-white text-black rounded-lg shadow-lg overflow-hidden ${generateMarginTopClass(index)} transition-all duration-500 ease-in-out delay-${index}`}>
                                                    <div className="md:flex">
                                                        <div className="md:w-1/2 p-2">
                                                            ...
                                                            <p className="text-gray-400 pb-2 pt-2">Created At: {new Intl.DateTimeFormat('en-GB').format(new Date(article.createdAt))}</p>
                                    ...
                                    <div id='bggrad' className="max-w-[70rem] mt-5 mx-auto p-4 bg-white   text-black rounded-lg shadow-2xl overflow-hidden">
